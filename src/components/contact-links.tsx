        ...
        return (
          <li key={label}>
            <a
              ...
              className="group relative flex items-center gap-4 overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-4 text-slate-100 shadow-md ring-1 ring-white/10 transition hover:-translate-y-0.5 hover:border-sky-300/50 hover:bg-sky-500/5"
            >
